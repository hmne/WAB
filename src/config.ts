...
const config: IConfig = {
	...
	gptPrefix: process.env.GPT_PREFIX || "بوت", // Default: !gpt
	dallePrefix: process.env.DALLE_PREFIX || "رسام", // Default: !dalle
	resetPrefix: process.env.RESET_PREFIX || "اعداة-ضبط", // Default: !reset
	aiConfigPrefix: process.env.AI_CONFIG_PREFIX || "ضبط1", // Default: !config
